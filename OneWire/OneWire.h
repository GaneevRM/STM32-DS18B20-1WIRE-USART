...
#define ONEWIRE_READ_ROM 0x33  //позволяет мастеру шины читать 64-разрядный код ROM
#define ONEWIRE_MATCH_ROM 0x55 //команда совпадение ROM позволяет мастеру обращаться к конкретному  ведомому устройству
#define ONEWIRE_CONVERT_TEMPERATURE 0x44 //команда инициализирует одно преобразование температуры
...
#define MAXDEVICES_ON_THE_BUS 6  // maximum planned number of devices on the bus
#endif

#define DS18B20 0x28  //код семейсва датчика для DS18B20
#define DS18S20 0x10  //код семейсва датчика для DS18S20
